...
#import "UIImage+LLTransform.h"
#define DegreesToRadians(degrees) ((degrees) * M_PI / 180)
#define RadiansToDegrees(radians) ((radians * 180 / M_PI))
@implementation UIImage (LLTransform)
- (UIImage *)ll_imageByScalingProportionallyToSize:(CGSize)targetSize by:(scalingBy)method
{
...
- (UIImage *)ll_imageByScalingProportionallyToSize:(CGSize)targetSize{
    UIImage *sourceImage = self;
    UIImage *newImage = nil;
...
{
    return [self ll_imageRotatedByDegrees:RadiansToDegrees(radians)];
}
