//
//  UINavigationController+LLStackManager.m
//  Categories
//
...
#import "UINavigationController+LLStackManager.h"

@implementation UINavigationController (LLStackManager)
/**
...
{
    return [self popToViewController:[self ll_findViewController:className] animated:YES];
}
/**
 *  @brief  pop n层
 *
